-- matchfoundr · Live Partner Offers
-- Native iOS and web should read partner/growth marketplace data from Supabase.
...
(
  'angel-readiness',
  'Angel Readiness Sprint',
  'matchfoundr Capital Desk',
  'capital',
  'Berlin',
  'Bereitet Angel-Runde, Onepager, Target List und Intro-Material fuer Pre-Seed vor.',
  86,
...
(
  'kfw-finance-desk',
  'KfW & Hausbank Finance Desk',
  'matchfoundr Capital Desk',
  'capital',
  'Deutschland',
  'Strukturiert Finanzierungsbedarf, Hausbank-Unterlagen und Foerderkredit-Optionen.',
  78,
  'https://www.kfw.de/inlandsfoerderung/Unternehmen/Gr%C3%BCndung-und-Nachfolge/?redirect=780608',
...
(
  'b2b-sales-motion',
  'B2B Sales Motion',
  'matchfoundr Growth Desk',
  'growth',
  'Remote',
  'ICP, Lead-Listen, Sequenzen und Discovery Script fuer die ersten 30 B2B-Gespraeche.',
  86,
...
(
  'launch-growth-sprint',
  'Launch Growth Sprint',
  'matchfoundr Growth Desk',
  'growth',
  'Berlin',
  'Launch-Plan, Landingpage-Review, Outreach-Sequenzen und erste Kanaltests.',
  86,
...
(
  'gtm-mentor-circle',
  'GTM Mentor Circle',
  'matchfoundr Mentor Network',
  'mentor',
  'Remote',
  'Mentoren fuer Go-to-Market, US-Expansion, ICP-Schaerfung und Enterprise Sales.',
  87,
  'https://www.germanaccelerator.com/our-programs',
  'https://www.germanaccelerator.com/our-programs',
  'ok',
...
(
  ...
  'mentor',
  'Remote',
  'Erfahrene Operator fuer Produkt, Sales, Hiring und erste Fuehrungsroutinen.',
  87,
  'https://www.startupgrind.com/startups/',
  'https://www.startupgrind.com/startups/',
  'error',
...
(
  'first-five-hires',
  'First Five Hires',
  'matchfoundr Talent Desk',
  'talent',
  'Deutschland',
  'Pipeline fuer erste Engineer-, Growth- und Ops-Rollen mit Founder-tauglicher Vorauswahl.',
  85,
  'https://wellfound.com/recruit',
  'https://wellfound.com/recruit',
  'error',
...
(
  ...
  'talent',
  'Remote',
  'Fractional Spezialisten fuer Design, Data, Finance und Growth bevor Vollzeit-Hiring Sinn ergibt.',
  78,
  'https://www.malt.de/',
  'https://www.malt.de/',
  'error',
...
(
  'startup-tax-readiness',
  'Startup Tax Readiness',
  'matchfoundr Partner Desk',
  'tax',
  'Remote',
  'Setup fuer Buchhaltung, USt, Lohn, DATEV-Export und erste Monatsabschluesse.',
  88,
  'https://www.lexware.de/gruenderedition/',
...
(
  'research-allowance-desk',
  'Forschungszulage Desk',
  'matchfoundr Partner Desk',
  'tax',
  'Deutschland',
  'Prueft FuE-Faehigkeit und strukturiert Nachweise fuer Forschungszulage-Antraege.',
  84,
