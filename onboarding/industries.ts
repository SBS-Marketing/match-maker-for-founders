...
export const INDUSTRIES: Industry[] = [
  {
    ...
    copilot_context:
      "Tech Startup, typische Themen: MVP, Product-Market Fit, VC-Funding, EXIST, Cap Table, Hiring.",
  },
  {
    id: "handwerk",
    ...
    terms: {
      ...
      stage_options: [
        "Idee / Plan",
        "Meisterbrief / Zulassung",
        "Erster Auftrag",
        "Fester Kundenstamm",
        "Zweiter Standort / Skalierung",
      ],
      idea_options: [
        "Schreinerei",
        "Elektrik / SHK",
    ...
    copilot_context:
      "Handwerksbetrieb, typische Themen: Meisterpflicht, Gewerbeanmeldung, Handwerkskammer, KfW-Kredit, Gesellenvertrag, Auftragsgewinnung.",
  },
  {
    id: "gastro",
    ...
    copilot_context:
      "Gastronomiebetrieb, typische Themen: HACCP, Konzession, Pachtvertrag, Lieferanten, SCHUFA, Hygienevorschriften, Social Media für Gastro.",
  },
  {
    id: "kreativ",
    ...
    copilot_context:
      "Kreativagentur oder Studio, typische Themen: Auftragsrecht, Urheberrecht, Freelancer vs. Festanstellung, Projektpreise, Portfolio aufbauen.",
  },
  {
    id: "handel",
    ...
    copilot_context:
      "E-Commerce oder Handel, typische Themen: Lieferanten, Shopify/Amazon, Logistik, Retouren, Performance Marketing, Markenaufbau.",
  },
  {
    id: "bildung",
    ...
    industry_skills: [
      ...
      "Impact-Messung",
      "Betriebserlaubnis (Kita/Schule)",
      "EdTech-Didaktik",
      "Inklusion",
      "Mehrsprachigkeit",
    ],
    copilot_context:
      "Bildungs- oder Sozialunternehmen, typische Themen: Gemeinnützigkeit, Förderanträge, Betriebserlaubnis, Ehrenamt vs. Festanstellung, Impact-Messung.",
  },
  {
    id: "gesundheit",
    ...
    primary_skills: ["ops", "marketing", "finance"],
    industry_skills: [
      "Approbation / Heilkundeerlaubnis",
      "Kassenzulassung",
      "Abrechnung (GOÄ/EBM)",
    ...
    copilot_context:
      "Gesundheits- oder Wellnessunternehmen, typische Themen: Approbation, Kassenzulassung, Datenschutz (Patientendaten), Praxisräume, Krankenkassen-Abrechnung.",
  },
  {
    id: "beratung",
    ...
    industry_skills: [
      ...
      "Proposal / Angebotsschreiben",
      "Workshop-Moderation",
      "Methodenkompetenz (Scrum/Lean)",
      "Steuerrecht",
      "Arbeitsrecht",
      "Vertragsrecht",
      "Audit / Due Diligence",
    ...
    copilot_context:
      "Beratungs- oder Dienstleistungsunternehmen, typische Themen: Positionierung, Akquise, Stundenpreise vs. Projektpreise, Partnerschaft-Modelle, Skalierung ohne Qualitätsverlust.",
  },
];
