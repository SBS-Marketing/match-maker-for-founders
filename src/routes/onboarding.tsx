          ...
          >
            ...
            {currentStep === "skills_picker" && (
              <StepSkillPicker
                ...
                industrySkills={industry.industry_skills}
...
function StepSkillPicker({
  ...
  // Order: industry-specific first, then primary categories, then the rest
  const orderedCategories = useMemo(() => {
    ...
    return [industryCat, ...primary, ...rest];
  }, [primaryCategories, industrySkills, industryLabel, industryEmoji]);
